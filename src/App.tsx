  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 flex flex-col items-center justify-center bg-[#f2d5d8] relative overflow-x-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-[430px] bg-[#f2eae1] rounded-[40px] shadow-2xl border border-white/20 overflow-hidden flex flex-col relative"
      ...
      >
        ...
        <div className="px-6 pb-6 pt-1 flex flex-col items-center text-center relative z-10 -mt-12">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-1 right-1 w-6 h-6 bg-[#ccafb1] rounded-full border-2 border-[#f2eae1] flex items-center justify-center text-white">
